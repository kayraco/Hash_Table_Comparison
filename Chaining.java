...
public class Chaining {
    ...
    public int chain (int key) {
    	...
    	//System.out.print((int)(A*key) % power2(w) >> (w-r));
    ...
    public int insertKey(int key){
    	//get the hashvalue of the inserted key which will be the index it will be inserted 
    	int h = chain(key);
    	Table.get(h).add(key);
    	//return number of collisions encountered
    	return Table.get(h).size()-1;
    }
